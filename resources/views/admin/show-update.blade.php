                        ...
                        <form style="width: 100%;" id="product-info-form" method="post" action="{{ route('product.update', $product->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-8">
                                    <label class="col-12 col-sm-3 col-form-label" id="url-simple">{{$product->url}}</label>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class=" form-group row">
                                ...
                                <div class="col-12 col-sm-8 col-lg-8">
                                    <input class="form-control" type="text" required="" placeholder="Tên sản phẩm" value="{{$product->name}}" name="name" id="name">
                                </div>
                            </div>
                            <div class="form-group row">
